...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.65\textwidth]{result-randn.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.65\textwidth]{result-rand_scaled.png}
  \caption{Erro relativo da aproximação do produto $AB$ via amostragem probabilística.}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.65\textwidth]{result-variance.png}
